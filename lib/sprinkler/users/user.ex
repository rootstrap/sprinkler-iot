defmodule Sprinkler.Users.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Sprinkler.Repo)
  ...
  """
  def valid_password?(%Sprinkler.Users.User{hashed_password: hashed_password}, password)
