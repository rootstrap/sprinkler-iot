defmodule SprinklerWeb.DashboardLive do
 ...
 @telemetry_topic "telemetry"
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, assign(socket, :devices,[%{id: 1, tmps: [2]}])}
  end

  def handle_info(
        %{topic: @telemetry_topic, event: "new_reading", payload: %{payload: payload, device_id: device_id}},
        socket
      ) do
    tmp = payload["tmp"]
    updated_list = Enum.map(socket.assigns.devices, fn
