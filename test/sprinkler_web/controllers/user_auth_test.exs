defmodule SprinklerWeb.UserAuthTest do
  use SprinklerWeb.ConnCase, async: true

  alias Sprinkler.Users
  alias SprinklerWeb.UserAuth
  import Sprinkler.UsersFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SprinklerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SprinklerWeb.Endpoint.subscribe(live_socket_id)
